-- Tournament Type
INSERT IGNORE INTO cricket_tournament.tournament_type(tournament_type_id, tournament_type, record_created_date, record_created_by, is_active)
VALUES(1, 'cricket', CURRENT_DATE(), UUID(), true);

-- Tournaments
INSERT IGNORE INTO cricket_tournament.tournament(tournament_id, tournament_type_id, tournament_name, tournament_description, tournament_year, maximum_overs_per_match, record_created_date, record_created_by, is_active)
...
-- Teams
-- Team
INSERT IGNORE INTO cricket_tournament.team(team_id, team_name, team_owner, record_created_date, record_created_by, is_active)
...
-- Team Stats
INSERT IGNORE INTO cricket_tournament.team_stats(team_stats_id, team_id, tournament_id, total_runs_scored, total_overs_played, total_runs_conceded, total_overs_bowled, record_created_date, record_created_by, is_active)
VALUES
...
-- PointsTable
INSERT IGNORE INTO cricket_tournament.points_table(points_table_id, tournament_id, team_id, played, won, lost, tied, no_result, points, net_match_rate, record_created_date, record_created_by, is_active)
VALUES
